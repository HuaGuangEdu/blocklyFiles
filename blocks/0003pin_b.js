...
Blockly.Blocks["math_arithmetic"]={
    ...
    this.appendValueInput('A', Number).setCheck('Number');
    var MODE1=[['+', '+'], ['-', '-'],['x','*'],['÷','/'],['^','**']];
    this.appendDummyInput('').appendField(new Blockly.FieldDropdown(MODE1),'MODE1');
    this.appendValueInput('B', Number).setCheck('Number');
...
Blockly.Blocks["math_modulo"]={
  ...
  this.appendValueInput('DIVIDEND', Number).setCheck('Number');
  this.appendDummyInput().appendField('÷');
  this.appendValueInput('DIVISOR', Number).setCheck('Number');
...
Blockly.Blocks["math_random_int"]={
  ...
  this.appendValueInput('FROM', Number).setCheck('Number');
  this.appendDummyInput().appendField('到');
  this.appendValueInput('TO', Number).setCheck('Number');
...
Blockly.Blocks["math_atan2"]={
  ...
  this.appendValueInput('X', Number).setCheck('Number');
  this.appendDummyInput().appendField(',y:');
  this.appendValueInput('Y', Number).setCheck('Number');
...
Blockly.Blocks["math_constrain"]={
  ...
  this.appendValueInput('VALUE', Number).setCheck('Number');
  this.appendDummyInput().appendField('限制在最低');
  this.appendValueInput('LOW', Number).setCheck('Number');
  this.appendDummyInput().appendField('到最高');
  this.appendValueInput('HIGH', Number).setCheck('Number');
